    ...
    <div className="relative min-h-screen text-foreground">
      ...
      <div className="relative z-10 flex flex-col items-center py-8 sm:py-10 px-4">
        <header className="mb-8 sm:mb-10 text-center">
          <div className="bg-card/90 backdrop-blur-md py-2 px-3 sm:py-3 sm:px-4 rounded-lg shadow-xl border border-white/20">
            <Image
              src="/dhl-logo.png"
              alt="DHL Logo"
              width={350}
            ...
            <p className="text-muted-foreground mt-1 text-sm sm:text-base">Recognizing our outstanding employees</p>
          </div>
        </header>
